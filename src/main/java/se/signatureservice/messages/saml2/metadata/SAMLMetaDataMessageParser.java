...
import se.signatureservice.messages.xmldsig.jaxb.KeyInfoType;
import se.signatureservice.messages.xmldsig.jaxb.X509DataType;
import se.signatureservice.messages.saml2.metadata.attr.jaxb.ObjectFactory;
...
public class SAMLMetaDataMessageParser extends BaseSAMLMessageParser {
    ...
    private static final String BASE_JAXB_CONTEXT = "se.signatureservice.messages.saml2.assertion.jaxb:se.signatureservice.messages.saml2.metadata.jaxb:se.signatureservice.messages.saml2.metadata.ui.jaxb:se.signatureservice.messages.saml2.metadata.attr.jaxb:se.signatureservice.messages.xenc.jaxb:se.signatureservice.messages.xmldsig.jaxb:se.signatureservice.messages.sweeid2.pricipalselection1_0.jaxb";
    ...
    private static se.signatureservice.messages.saml2.metadata.jaxb.ObjectFactory mdOf = new se.signatureservice.messages.saml2.metadata.jaxb.ObjectFactory();
    private static se.signatureservice.messages.saml2.metadata.ui.jaxb.ObjectFactory uiOf = new se.signatureservice.messages.saml2.metadata.ui.jaxb.ObjectFactory();
    private static ObjectFactory attrOf = new ObjectFactory();
