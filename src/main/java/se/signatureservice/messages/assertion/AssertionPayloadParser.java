...
import se.signatureservice.messages.csmessages.BasePayloadParser;
...
import se.signatureservice.messages.saml2.protocol.jaxb.AttributeQueryType;
import se.signatureservice.messages.saml2.protocol.jaxb.ResponseType;
import se.signatureservice.messages.saml2.protocol.jaxb.StatusCodeType;
import se.signatureservice.messages.saml2.protocol.jaxb.StatusType;
import se.signatureservice.messages.utils.*;
import se.signatureservice.messages.xenc.jaxb.EncryptedDataType;
...
public class AssertionPayloadParser extends BasePayloadParser {
	...
	private se.signatureservice.messages.saml2.assertion.jaxb.ObjectFactory of = new se.signatureservice.messages.saml2.assertion.jaxb.ObjectFactory();
	private ObjectFactory samlpOf = new ObjectFactory();
	...
	public String getJAXBPackage() {
		return "se.signatureservice.messages.saml2.assertion.jaxb";
	}

	/**
	 * @see PayloadParser#getSchemaAsInputStream(java.lang.String)
	 */
    ...
    private JAXBContext getJAXBContext() throws JAXBException{
    	if(jaxbContext== null){
    		String jaxbClassPath = "se.signatureservice.messages.saml2.assertion.jaxb:se.signatureservice.messages.saml2.protocol.jaxb:se.signatureservice.messages.xenc.jaxb:se.signatureservice.messages.xmldsig.jaxb";
    ...
    private JAXBContext getUserDataJAXBContext() throws JAXBException{
    	if(userDataJaxbContext== null){
    		String jaxbClassPath = "se.signatureservice.messages.saml2.assertion.jaxb:se.signatureservice.messages.saml2.protocol.jaxb:se.signatureservice.messages.xenc.jaxb:se.signatureservice.messages.xmldsig.jaxb:se.signatureservice.messages.credmanagement.jaxb";
