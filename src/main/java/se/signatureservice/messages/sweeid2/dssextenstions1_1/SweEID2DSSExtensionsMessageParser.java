...
import se.signatureservice.messages.NoDecryptionKeyFoundException;
...
import se.signatureservice.messages.saml2.assertion.jaxb.*;
import se.signatureservice.messages.sweeid2.dssextenstions1_1.jaxb.*;
import se.signatureservice.messages.sweeid2.dssextenstions1_1.jaxb.AnyType;
...
public class SweEID2DSSExtensionsMessageParser extends DSS1CoreMessageParser{
    ...
    private static final String BASE_JAXB_CONTEXT = "se.signatureservice.messages.sweeid2.dssextenstions1_1.jaxb:se.signatureservice.messages.saml2.assertion.jaxb:se.signatureservice.messages.xenc.jaxb";
    ...
    public byte[] genSignRequest(ContextMessageSecurityProvider.Context context,String requestID, String profile, JAXBElement<SignRequestExtensionType> signRequestExtension, JAXBElement<SignTasksType> signTasks, boolean sign) throws MessageProcessingException, MessageContentException {
        ...
        se.signatureservice.messages.dss1.core.jaxb.AnyType at = dssOf.createAnyType();
