...
package org.certificateservices.messages.saml2.metadata.attr.jaxb;
...
@XmlType(name = "EntityAttributesType", propOrder = {
    "attributeOrAssertion"
})
public class EntityAttributesType {

    @XmlElements({
        @XmlElement(name = "Attribute", namespace = "urn:oasis:names:tc:SAML:2.0:assertion", type = AttributeType.class),
        @XmlElement(name = "Assertion", namespace = "urn:oasis:names:tc:SAML:2.0:assertion", type = AssertionType.class)
    })
    protected List<Object> attributeOrAssertion;
     ...
     * 
     */
    public List<Object> getAttributeOrAssertion() {
        if (attributeOrAssertion == null) {
            attributeOrAssertion = new ArrayList<Object>();
        }
        return this.attributeOrAssertion;
    }
