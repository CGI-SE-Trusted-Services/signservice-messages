...
@XmlType(name = "")
@XmlRootElement(name = "GetAvailableKeyStoreInfoRequest", namespace = "http://certificateservices.org/xsd/keystoremgmt2_0")
public class GetAvailableKeyStoreInfoRequest
    extends CSRequest
{
