...
import se.signatureservice.messages.credmanagement.jaxb.GetCredentialResponse;
...
class AutoRevokeReqRespManagerSpec extends Specification{
	...
	@Shared se.signatureservice.messages.credmanagement.jaxb.ObjectFactory credOf = new se.signatureservice.messages.credmanagement.jaxb.ObjectFactory()
