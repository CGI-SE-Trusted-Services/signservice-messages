...
import se.signatureservice.messages.assertion.AuthorizationAssertionData;
...
import se.signatureservice.messages.credmanagement.jaxb.ChangeCredentialStatusResponse
