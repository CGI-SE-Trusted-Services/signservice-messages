package se.signatureservice.messages.saml2.metadata
...
import se.signatureservice.messages.saml2.metadata.jaxb.AdditionalMetadataLocationType
import se.signatureservice.messages.saml2.metadata.jaxb.AffiliationDescriptorType
import se.signatureservice.messages.saml2.metadata.jaxb.AttributeConsumingServiceType
import se.signatureservice.messages.saml2.metadata.jaxb.ContactType
import se.signatureservice.messages.saml2.metadata.jaxb.ContactTypeType
import se.signatureservice.messages.saml2.metadata.jaxb.EndpointType
...
import se.signatureservice.messages.saml2.metadata.jaxb.ExtensionsType
import se.signatureservice.messages.saml2.metadata.jaxb.IDPSSODescriptorType
import se.signatureservice.messages.saml2.metadata.jaxb.IndexedEndpointType
...
import se.signatureservice.messages.saml2.metadata.jaxb.LocalizedNameType
import se.signatureservice.messages.saml2.metadata.jaxb.LocalizedURIType
import se.signatureservice.messages.saml2.metadata.jaxb.OrganizationType
import se.signatureservice.messages.saml2.metadata.jaxb.RequestedAttributeType
import se.signatureservice.messages.saml2.metadata.jaxb.SPSSODescriptorType
import se.signatureservice.messages.saml2.metadata.ui.jaxb.DiscoHintsType
import se.signatureservice.messages.saml2.metadata.ui.jaxb.KeywordsType
import se.signatureservice.messages.saml2.metadata.ui.jaxb.LogoType
import se.signatureservice.messages.saml2.metadata.ui.jaxb.ObjectFactory
import se.signatureservice.messages.saml2.metadata.ui.jaxb.UIInfoType
import se.signatureservice.messages.sweeid2.pricipalselection1_0.PrincipalSelectionGenerator
import se.signatureservice.messages.sweeid2.pricipalselection1_0.jaxb.MatchValueType
...
import se.signatureservice.messages.xenc.jaxb.EncryptionMethodType
...
class SAMLMetaDataMessageParserSpec extends CommonSAMLMessageParserSpecification {
	...
	se.signatureservice.messages.saml2.metadata.jaxb.ObjectFactory mdOf = new se.signatureservice.messages.saml2.metadata.jaxb.ObjectFactory()
	...
	def "Verify that genMDAttribute generates valid extension data in a EntityDataType"(){
		...
		//printXML(dtd)
		def xml = TestUtils.slurpXml(dtd)
	...
	private List<EncryptionMethodType> createEncryptionMethods(){
		se.signatureservice.messages.xenc.jaxb.ObjectFactory encOf = new se.signatureservice.messages.xenc.jaxb.ObjectFactory();
