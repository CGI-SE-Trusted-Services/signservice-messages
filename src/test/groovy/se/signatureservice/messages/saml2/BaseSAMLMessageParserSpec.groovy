...
import se.signatureservice.messages.saml2.assertion.jaxb.AudienceRestrictionType
...
class BaseSAMLMessageParserSpec extends CommonSAMLMessageParserSpecification {
	...
	def "Verify that init with custom JAXB and Schema setting is initialized properly"(){
	   setup:
		...
		c.setProperty(BaseSAMLMessageParser.SETTING_CUSTOM_JAXBCLASSPATH, "se.signatureservice.messages.csmessages.jaxb:se.signatureservice.messages.credmanagement.jaxb")
		...
		customMock.getCustomJAXBClasspath() >> "se.signatureservice.messages.csmessages.jaxb:se.signatureservice.messages.credmanagement.jaxb"
		...
		then:
		p.customJAXBClasspath == "se.signatureservice.messages.csmessages.jaxb:se.signatureservice.messages.credmanagement.jaxb"
