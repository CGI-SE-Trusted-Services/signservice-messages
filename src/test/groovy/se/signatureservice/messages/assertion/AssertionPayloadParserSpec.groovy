...
import se.signatureservice.messages.csmessages.jaxb.ApproverType
...
import se.signatureservice.messages.utils.XMLUtils
...
import static se.signatureservice.messages.csmessages.DefaultCSMessageParserSpec.TEST_ID
...
class AssertionPayloadParserSpec extends Specification {
	...
	se.signatureservice.messages.xenc.jaxb.ObjectFactory xencObj = new se.signatureservice.messages.xenc.jaxb.ObjectFactory()
	se.signatureservice.messages.xmldsig.jaxb.ObjectFactory dsignObj = new se.signatureservice.messages.xmldsig.jaxb.ObjectFactory()
	...
	def "Verify that JAXBPackage(), getNameSpace(), getSchemaAsInputStream(), getSupportedVersions(), getDefaultPayloadVersion() returns the correct values"(){
		expect:
		pp.getJAXBPackage() == "se.signatureservice.messages.saml2.assertion.jaxb"
