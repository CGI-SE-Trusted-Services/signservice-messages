...
class AssertionPayloadParserSpec extends Specification {
	...
	org.signatureservice.messages.saml2.assertion.jaxb.ObjectFactory of = new org.signatureservice.messages.saml2.assertion.jaxb.ObjectFactory()
    ObjectFactory csMessageOf = new ObjectFactory()
	org.signatureservice.messages.xenc.jaxb.ObjectFactory xencObj = new org.signatureservice.messages.xenc.jaxb.ObjectFactory()
	org.signatureservice.messages.xmldsig.jaxb.ObjectFactory dsignObj = new org.signatureservice.messages.xmldsig.jaxb.ObjectFactory()
